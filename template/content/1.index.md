...
# Content Wind :icon{name="carbon:sailboat-coastal" color="#818cf8" size="2rem"}Hello from Studio
...
If you want to go deeper, take a look at the [`<List>`](https://github.com/Atinux/content-wind/blob/main/theme/components/content/List.vue) component to see some `useUnwrap()` magic 🪄

## Deployment

![Deploy with Vercel](https://vercel.com/button) ![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)
